...
//            delete it from xml
        ...
        public function update(Phone $phone)
        {
            ...
            $users = simplexml_load_file('public/xml_data/tool.xml');
            ...
            file_put_contents('public/xml_data/tool.xml', $users->asXML());
